...
#from imblearn.utils._validation import _deprecate_positional_args  # noqa
...
class BalancedBatchGenerator(*ParentClass):
    ...
    def __init__(
        ...
        *,
        ...
        self.X = X#.reshape(-1,np.product(input_size))
        self.y = y
    ...
    def __getitem__(self, index):
        ...
        X_resampled = X_resampled.reshape(-1, self.input_size[0], self.input_size[1], self.input_size[2])
